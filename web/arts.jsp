...
rs=stmt.executeQuery("select distinct(course_name) from fees where deparment='ARTS'");
}catch(Exception e){
            out.println(e);}
...
//String status=null;
            ...
            <tr>
                ...
                <td style="color:#f4511e; font-size: 18px;">&nbsp;&nbsp;<a href="artsinst.jsp"><%=rs.getString("course_name")%></a>&nbsp;&nbsp;</td>
