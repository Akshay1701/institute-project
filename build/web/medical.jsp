...
rs=stmt.executeQuery("select distinct(course_name) from fees where deparment='MEDICAL'");
}catch(Exception e){
            out.println(e);}
...
//String status=null;
            ...
            <tr>
                ...
                <td style="color:#f4511e; font-size: 18px;">&nbsp;&nbsp;<a href="medicalist.jsp"><%=rs.getString("course_name")%></a>&nbsp;&nbsp;</td>
